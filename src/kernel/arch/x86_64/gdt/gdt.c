...
void gdt_init(void) {
  ...
  gdt_set_gate(1, 0, 0xFFFFF,
               GDT_PRESENT | GDT_RING0 | GDT_CODE_DATA | GDT_EXECUTABLE |
                   GDT_RW,
               GDT_GRANULAR | GDT_LONG_MODE);

  // kernel data Segment (0x10)
  gdt_set_gate(2, 0, 0xFFFFF, GDT_PRESENT | GDT_RING0 | GDT_CODE_DATA | GDT_RW,
               GDT_GRANULAR | GDT_LONG_MODE);

  // user data Segment (0x18)
  gdt_set_gate(3, 0, 0xFFFFF, GDT_PRESENT | GDT_RING3 | GDT_CODE_DATA | GDT_RW,
               GDT_GRANULAR | GDT_LONG_MODE);

  // user code Segment (0x20)
  gdt_set_gate(4, 0, 0xFFFFF,
               GDT_PRESENT | GDT_RING3 | GDT_CODE_DATA | GDT_EXECUTABLE |
                   GDT_RW,
               GDT_GRANULAR | GDT_LONG_MODE);
