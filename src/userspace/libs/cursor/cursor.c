...
static const unsigned int cursor_px[CW * CH] = {
    B, T, T, T, T, T, T, T, T, T, T, T, B, B, T, T, T, T, T, T, T, T, T, T,
    B, W, B, T, T, T, T, T, T, T, T, T, B, W, W, B, T, T, T, T, T, T, T, T,
    B, W, W, W, B, T, T, T, T, T, T, T, B, W, W, W, W, B, T, T, T, T, T, T,
    B, W, W, W, W, W, B, T, T, T, T, T, B, W, W, W, W, W, W, B, T, T, T, T,
    B, W, W, W, W, W, W, W, B, T, T, T, B, W, W, W, W, W, W, W, W, B, T, T,
    B, W, W, W, W, W, W, W, W, W, B, T, B, W, W, W, W, B, B, B, B, B, B, T,
    B, W, W, W, B, T, T, T, T, T, T, T, B, W, W, B, T, T, T, T, T, T, T, T,
    B, W, B, T, T, T, T, T, T, T, T, T, B, B, T, T, T, T, T, T, T, T, T, T,
};
...
int main(void) {
  ...
  for (;;) {
    mouse_event_t ev;
    if ((int)read(mfd, &ev, sizeof(ev)) < (int)sizeof(ev))
      continue;
    ...
    if (bg_valid) {
      fb_rect_t rst = {.x = (unsigned)old_x,
                       .y = (unsigned)old_y,
                       .w = SCW,
                       .h = SCH,
                       .pixels = bg_save};
    ...
    fb_rect_t drw = {.x = (unsigned)nx,
                     .y = (unsigned)ny,
                     .w = SCW,
                     .h = SCH,
                     .pixels = scaled_cursor};
